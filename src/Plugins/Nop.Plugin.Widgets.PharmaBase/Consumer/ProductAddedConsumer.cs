...
{
    public class ProductAddedConsumer : IConsumer<EntityInsertedEvent<Product>>
    {
        ...
        private async Task<IActionResult> SendNewProduct(Product product)
        {
            ...
            var url = $"{baseUrl}api/v1/company/products";
